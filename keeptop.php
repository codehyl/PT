...
<?php
    ...
    sum(case when t2.team in (1,2,3,4,12,17,20,21,22) then t2.size else 0 end)  as osize,
    sum(case when t2.team in (1,2,3,4,12,17,20,21,22) then 1 else 0 end)  as osl,
    sum(case when t2.team in (1,2,3,4,12,17,20,21,22) then t2.size else t2.size/4 end)  as csize,
    sum(case when t2.team in (1,2,3,4,12,17,20,21,22) then 1 else 0.25 end)  as csl
